import { objectHandler, arrayHandler, batchHandler } from "../response/handlers";
...
export namespace Call {
    ...
    export async function method<T extends BX24WResponse>(
        ...
        return handler === null ? result : new Proxy(result, {...objectHandler, ...handler});
    }
    ...
    export async function listMethod<T extends BX24WResponse[]>(
        ...
        return handler === null ? result : new Proxy(result, {...arrayHandler, ...handler});
    }
    ...
    export async function longBatch(
        ...
        return handler === null ? result : new Proxy(result, {...batchHandler, ...handler});
    }
}
