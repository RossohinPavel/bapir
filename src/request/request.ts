import { object, array, batch } from "../response/handler";
...
export namespace Call {
    ...
    export async function method<T extends BX24WResponse>(
        ...
        return handler === null ? result : new Proxy(result, {...object, ...handler});
    }
    ...
    export async function listMethod<T extends BX24WResponse[]>(
        ...
        return handler === null ? result : new Proxy(result, {...array, ...handler});
    }
    ...
    export async function longBatch(
        ...
        return handler === null ? result : new Proxy(result, {...batch, ...handler});
    }
}
